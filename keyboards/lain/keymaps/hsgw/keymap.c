...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT(
        ...
        KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,               KC_INS, KC_N,    KC_M,    JP_COMM, JP_DOT,   JP_SLSH, \
        KC_LSFT,                   KC_LALT, GUI_ZH,  NUM_SPC, KC_LSFT,   KC_ENT, FUNC_BS, MO(FUNC),KC_MENU, JP_CIRC,  JP_BSLS\
    ),
    [NUM] = LAYOUT(
